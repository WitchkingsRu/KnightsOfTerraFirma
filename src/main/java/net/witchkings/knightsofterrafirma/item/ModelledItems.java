...
public class ModelledItems extends ModItemsProvider {
    ...
    public static final RegistrySupplier<DyeableWearableArmorDecorationItem> SILVER_CROWN_DECORATION = INSTANCE.addDyeableWearableArmorDecorationItem("silver_crown_decoration", ModArmor.SILVER_CROWN, ArmorItem.Type.HELMET, new Item.Properties(), MapColor.WATER.col);
    public static final RegistrySupplier<DyeableWearableArmorDecorationItem> ST_SILVER_CROWN_DECORATION = INSTANCE.addDyeableWearableArmorDecorationItem("sterling_silver_crown_decoration", ModArmor.ST_SILVER_CROWN, ArmorItem.Type.HELMET, new Item.Properties(), MapColor.LAPIS.col);
    public static final RegistrySupplier<DyeableWearableArmorDecorationItem> PLATINUM_CROWN_DECORATION = INSTANCE.addDyeableWearableArmorDecorationItem("platinum_crown_decoration", ModArmor.PLATINUM_CROWN, ArmorItem.Type.HELMET, new Item.Properties(), MapColor.NETHER.col);
    ...
    public static final RegistrySupplier<DyeableWearableArmorDecorationItem> ROSE_GOLD_CROWN_DECORATION = INSTANCE.addDyeableWearableArmorDecorationItem("rose_gold_crown_decoration", ModArmor.ROSE_GOLD_CROWN, ArmorItem.Type.HELMET, new Item.Properties(), MapColor.WARPED_STEM.col);

    public static final RegistrySupplier<DyeableWearableArmorDecorationItem> COPPER_CROWN_DECORATION = INSTANCE.addDyeableWearableArmorDecorationItem("copper_crown_decoration", ModArmor.COPPER_CROWN, ArmorItem.Type.HELMET, new Item.Properties(), MapColor.GOLD.col);
    public static final RegistrySupplier<DyeableWearableArmorDecorationItem> BRONZE_CROWN_DECORATION = INSTANCE.addDyeableWearableArmorDecorationItem("bronze_crown_decoration", ModArmor.BRONZE_CROWN, ArmorItem.Type.HELMET, new Item.Properties(), MapColor.EMERALD.col);
    public static final RegistrySupplier<DyeableWearableArmorDecorationItem> BISMUTH_BRONZE_CROWN_DECORATION = INSTANCE.addDyeableWearableArmorDecorationItem("bismuth_bronze_crown_decoration", ModArmor.BISMUTH_BRONZE_CROWN, ArmorItem.Type.HELMET, new Item.Properties(), MapColor.GOLD.col);
    public static final RegistrySupplier<DyeableWearableArmorDecorationItem> BLACK_BRONZE_CROWN_DECORATION = INSTANCE.addDyeableWearableArmorDecorationItem("black_bronze_crown_decoration", ModArmor.BLACK_BRONZE_CROWN, ArmorItem.Type.HELMET, new Item.Properties(), MapColor.ICE.col);

    public static final RegistrySupplier<DyeableWearableArmorDecorationItem> BLACK_STEEL_CROWN_DECORATION = INSTANCE.addDyeableWearableArmorDecorationItem("black_steel_crown_decoration", ModArmor.BLACK_STEEL_CROWN, ArmorItem.Type.HELMET, new Item.Properties(), MapColor.FIRE.col);
    public static final RegistrySupplier<DyeableWearableArmorDecorationItem> BLUE_STEEL_CROWN_DECORATION = INSTANCE.addDyeableWearableArmorDecorationItem("blue_steel_crown_decoration", ModArmor.BLUE_STEEL_CROWN, ArmorItem.Type.HELMET, new Item.Properties(), MapColor.DIAMOND.col);
    public static final RegistrySupplier<DyeableWearableArmorDecorationItem> RED_STEEL_CROWN_DECORATION = INSTANCE.addDyeableWearableArmorDecorationItem("red_steel_crown_decoration", ModArmor.RED_STEEL_CROWN, ArmorItem.Type.HELMET, new Item.Properties(), MapColor.COLOR_PURPLE.col);
