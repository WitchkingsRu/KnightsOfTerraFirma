...
public class AntiqueItems extends ModItemsProvider {
    ...
    public static final RegistrySupplier<MedievalShieldItem> BLACK_BRONZE_REPUBLIC_SCUTUM = INSTANCE.addMedievalShieldItem("black_bronze_republic_scutum", "republic_scutum", new Item.Properties(), BLACK_BRONZE, true, true, AddonItems.SHIELDS_CONFIG.get("republicScutum"));
    public static final RegistrySupplier<MedievalShieldItem> BLACK_BRONZE_IMPERIAL_SCUTUM = INSTANCE.addMedievalShieldItem("black_bronze_imperial_scutum", "imperial_scutum", new Item.Properties(), BLACK_BRONZE, true, true, AddonItems.SHIELDS_CONFIG.get("imperialScutum"));
    public static final RegistrySupplier<MedievalShieldItem> BLACK_BRONZE_TUREOS = INSTANCE.addMedievalShieldItem("black_bronze_tureos", "tureos", new Item.Properties(), BLACK_BRONZE, true, true, AddonItems.SHIELDS_CONFIG.get("tureos"));
    public static final RegistrySupplier<MedievalShieldItem> BLACK_BRONZE_HOPLON = INSTANCE.addMedievalShieldItem("black_bronze_hoplon", "hoplon", new Item.Properties(), BLACK_BRONZE, true, true, AddonItems.SHIELDS_CONFIG.get("hoplon"));

    public static final RegistrySupplier<MedievalShieldItem> BISMUTH_BRONZE_REPUBLIC_SCUTUM = INSTANCE.addMedievalShieldItem("bismuth_bronze_republic_scutum", "republic_scutum", new Item.Properties(), BISMUTH_BRONZE, true, true, AddonItems.SHIELDS_CONFIG.get("republicScutum"));
    public static final RegistrySupplier<MedievalShieldItem> BISMUTH_BRONZE_IMPERIAL_SCUTUM = INSTANCE.addMedievalShieldItem("bismuth_bronze_imperial_scutum", "imperial_scutum", new Item.Properties(), BISMUTH_BRONZE, true, true, AddonItems.SHIELDS_CONFIG.get("imperialScutum"));
    public static final RegistrySupplier<MedievalShieldItem> BISMUTH_BRONZE_TUREOS = INSTANCE.addMedievalShieldItem("bismuth_bronze_tureos", "tureos", new Item.Properties(), BISMUTH_BRONZE, true, true, AddonItems.SHIELDS_CONFIG.get("tureos"));
    public static final RegistrySupplier<MedievalShieldItem> BISMUTH_BRONZE_HOPLON = INSTANCE.addMedievalShieldItem("bismuth_bronze_hoplon", "hoplon", new Item.Properties(), BISMUTH_BRONZE, true, true, AddonItems.SHIELDS_CONFIG.get("hoplon"));

    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_ANTIQUE_DAGGER = INSTANCE.addMedievalWeaponItem("bismuth_bronze_antique_dagger", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("antiqueDagger"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_SICA = INSTANCE.addMedievalWeaponItem("bismuth_bronze_sica", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("sica"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_ANTIQUE_SPEAR = INSTANCE.addMedievalWeaponItem("bismuth_bronze_antique_spear", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("antiqueSpear"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_DORU = INSTANCE.addMedievalWeaponItem("bismuth_bronze_doru", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("doru"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_RETIARIUS = INSTANCE.addMedievalWeaponItem("bismuth_bronze_retiarius", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("retiarius"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_SARISSA = INSTANCE.addMedievalWeaponItem("bismuth_bronze_sarissa", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("sarissa"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_TRIARII_SPEAR = INSTANCE.addMedievalWeaponItem("bismuth_bronze_triarii_spear", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("triariiSpear"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_ANTIQUE_SWORD = INSTANCE.addMedievalWeaponItem("bismuth_bronze_antique_sword", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("antiqueSword"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_CELTIC_SWORD = INSTANCE.addMedievalWeaponItem("bismuth_bronze_celtic_sword", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("celticSword"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_EARLY_SPATHA = INSTANCE.addMedievalWeaponItem("bismuth_bronze_early_spatha", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("earlySpatha"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_GLADIATOR_SWORD = INSTANCE.addMedievalWeaponItem("bismuth_bronze_gladiator_sword", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("gladiatorSword"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_GLADIUS = INSTANCE.addMedievalWeaponItem("bismuth_bronze_gladius", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("gladius"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_KOPIS = INSTANCE.addMedievalWeaponItem("bismuth_bronze_kopis", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("kopis"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_REPUBLIC_GLADIUS = INSTANCE.addMedievalWeaponItem("bismuth_bronze_republic_gladius", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("republicGladius"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_RHOMPHAIA = INSTANCE.addMedievalWeaponItem("bismuth_bronze_rhomphaia", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("rhomphaia"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_SINGLE_EDGED_SWORD = INSTANCE.addMedievalWeaponItem("bismuth_bronze_single_edged_sword", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("singleEdgedSword"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_SPATHA = INSTANCE.addMedievalWeaponItem("bismuth_bronze_spatha", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("spatha"));
    public static final RegistrySupplier<MedievalWeaponItem> BISMUTH_BRONZE_XIPHOS = INSTANCE.addMedievalWeaponItem("bismuth_bronze_xiphos", new Item.Properties(), BISMUTH_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("xiphos"));

    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_ANTIQUE_DAGGER = INSTANCE.addMedievalWeaponItem("bronze_antique_dagger", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("antiqueDagger"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_SICA = INSTANCE.addMedievalWeaponItem("bronze_sica", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("sica"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_ANTIQUE_SPEAR = INSTANCE.addMedievalWeaponItem("bronze_antique_spear", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("antiqueSpear"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_DORU = INSTANCE.addMedievalWeaponItem("bronze_doru", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("doru"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_RETIARIUS = INSTANCE.addMedievalWeaponItem("bronze_retiarius", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("retiarius"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_SARISSA = INSTANCE.addMedievalWeaponItem("bronze_sarissa", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("sarissa"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_TRIARII_SPEAR = INSTANCE.addMedievalWeaponItem("bronze_triarii_spear", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("triariiSpear"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_ANTIQUE_SWORD = INSTANCE.addMedievalWeaponItem("bronze_antique_sword", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("antiqueSword"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_CELTIC_SWORD = INSTANCE.addMedievalWeaponItem("bronze_celtic_sword", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("celticSword"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_EARLY_SPATHA = INSTANCE.addMedievalWeaponItem("bronze_early_spatha", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("earlySpatha"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_GLADIATOR_SWORD = INSTANCE.addMedievalWeaponItem("bronze_gladiator_sword", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("gladiatorSword"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_GLADIUS = INSTANCE.addMedievalWeaponItem("bronze_gladius", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("gladius"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_KOPIS = INSTANCE.addMedievalWeaponItem("bronze_kopis", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("kopis"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_REPUBLIC_GLADIUS = INSTANCE.addMedievalWeaponItem("bronze_republic_gladius", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("republicGladius"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_RHOMPHAIA = INSTANCE.addMedievalWeaponItem("bronze_rhomphaia", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("rhomphaia"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_SINGLE_EDGED_SWORD = INSTANCE.addMedievalWeaponItem("bronze_single_edged_sword", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("singleEdgedSword"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_SPATHA = INSTANCE.addMedievalWeaponItem("bronze_spatha", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("spatha"));
    public static final RegistrySupplier<MedievalWeaponItem> BRONZE_XIPHOS = INSTANCE.addMedievalWeaponItem("bronze_xiphos", new Item.Properties(), BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("xiphos"));

    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_ANTIQUE_DAGGER = INSTANCE.addMedievalWeaponItem("black_bronze_antique_dagger", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("antiqueDagger"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_SICA = INSTANCE.addMedievalWeaponItem("black_bronze_sica", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("sica"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_ANTIQUE_SPEAR = INSTANCE.addMedievalWeaponItem("black_bronze_antique_spear", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("antiqueSpear"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_DORU = INSTANCE.addMedievalWeaponItem("black_bronze_doru", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("doru"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_RETIARIUS = INSTANCE.addMedievalWeaponItem("black_bronze_retiarius", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("retiarius"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_SARISSA = INSTANCE.addMedievalWeaponItem("black_bronze_sarissa", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("sarissa"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_TRIARII_SPEAR = INSTANCE.addMedievalWeaponItem("black_bronze_triarii_spear", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("triariiSpear"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_ANTIQUE_SWORD = INSTANCE.addMedievalWeaponItem("black_bronze_antique_sword", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("antiqueSword"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_CELTIC_SWORD = INSTANCE.addMedievalWeaponItem("black_bronze_celtic_sword", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("celticSword"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_EARLY_SPATHA = INSTANCE.addMedievalWeaponItem("black_bronze_early_spatha", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("earlySpatha"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_GLADIATOR_SWORD = INSTANCE.addMedievalWeaponItem("black_bronze_gladiator_sword", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("gladiatorSword"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_GLADIUS = INSTANCE.addMedievalWeaponItem("black_bronze_gladius", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("gladius"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_KOPIS = INSTANCE.addMedievalWeaponItem("black_bronze_kopis", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("kopis"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_REPUBLIC_GLADIUS = INSTANCE.addMedievalWeaponItem("black_bronze_republic_gladius", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("republicGladius"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_RHOMPHAIA = INSTANCE.addMedievalWeaponItem("black_bronze_rhomphaia", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("rhomphaia"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_SINGLE_EDGED_SWORD = INSTANCE.addMedievalWeaponItem("black_bronze_single_edged_sword", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("singleEdgedSword"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_SPATHA = INSTANCE.addMedievalWeaponItem("black_bronze_spatha", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("spatha"));
    public static final RegistrySupplier<MedievalWeaponItem> BLACK_BRONZE_XIPHOS = INSTANCE.addMedievalWeaponItem("black_bronze_xiphos", new Item.Properties(), BLACK_BRONZE, AddonItems.WEAPONS_CONFIG.getMelee("xiphos"));

    public static final RegistrySupplier<MedievalWeaponItem> IRON_BISMUTH_BRONZE_ANTIQUE_DAGGER = INSTANCE.addMedievalWeaponItem("iron_bismuth_bronze_antique_dagger", new Item.Properties(), IRON, AddonItems.WEAPONS_CONFIG.getMelee("antiqueDagger"));
    public static final RegistrySupplier<MedievalWeaponItem> IRON_BISMUTH_BRONZE_CELTIC_SWORD = INSTANCE.addMedievalWeaponItem("iron_bismuth_bronze_celtic_sword", new Item.Properties(), IRON, AddonItems.WEAPONS_CONFIG.getMelee("celticSword"));
    public static final RegistrySupplier<MedievalWeaponItem> IRON_BISMUTH_BRONZE_ANTIQUE_SWORD = INSTANCE.addMedievalWeaponItem("iron_bismuth_bronze_antique_sword", new Item.Properties(), IRON, AddonItems.WEAPONS_CONFIG.getMelee("antiqueSword"));

    public static final RegistrySupplier<MedievalWeaponItem> IRON_BLACK_BRONZE_ANTIQUE_DAGGER = INSTANCE.addMedievalWeaponItem("iron_black_bronze_antique_dagger", new Item.Properties(), IRON, AddonItems.WEAPONS_CONFIG.getMelee("antiqueDagger"));
    public static final RegistrySupplier<MedievalWeaponItem> IRON_BLACK_BRONZE_CELTIC_SWORD = INSTANCE.addMedievalWeaponItem("iron_black_bronze_celtic_sword", new Item.Properties(), IRON, AddonItems.WEAPONS_CONFIG.getMelee("celticSword"));
    public static final RegistrySupplier<MedievalWeaponItem> IRON_BLACK_BRONZE_ANTIQUE_SWORD = INSTANCE.addMedievalWeaponItem("iron_black_bronze_antique_sword", new Item.Properties(), IRON, AddonItems.WEAPONS_CONFIG.getMelee("antiqueSword"));
